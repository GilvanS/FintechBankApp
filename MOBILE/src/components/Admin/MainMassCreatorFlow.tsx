...
export const MainMassCreatorFlow: React.FC<Props> = ({ onSuccess, onCancel }) => {
    ...
    return (
        <div className="w-full max-w-6xl mx-auto space-y-4 p-4">
            ...
            <div className={`p-4 rounded-3xl ${cardClass} flex flex-col sm:flex-row items-stretch sm:items-center gap-3`}>
                ...
                <div className="flex gap-2 shrink-0">
                    <button
                        ...
                        className={`px-4 py-2.5 rounded-2xl text-xs flex items-center gap-2 cursor-pointer transition-transform hover:scale-[1.03] active:scale-95 ${primaryBtnClass}`}
                    >
                    ...
                    <button
                        ...
                        className={`px-4 py-2.5 rounded-2xl text-xs flex items-center gap-2 cursor-pointer transition-transform hover:scale-[1.03] active:scale-95 disabled:opacity-40 disabled:hover:scale-100 ${successBtnClass}`}
                    >
            ...
            <div className="grid grid-cols-1 lg:grid-cols-[1.05fr_0.95fr] gap-4 lg:items-start">
                {/* Coluna esquerda */}
                <div className="contents lg:block lg:space-y-4">
                    {/* PERFIL */}
                    <div className={`order-1 p-4 rounded-3xl ${cardClass} space-y-3 animate-fade-in`}>
                    ...
                    {/* FINANCEIRO */}
                    <div className={`order-3 p-4 rounded-3xl ${cardClass} space-y-3 animate-fade-in`}>
                ...
                <div className="contents lg:block lg:space-y-4">
                    ...
                    <div className={`order-2 p-4 rounded-3xl ${cardClass} space-y-3 animate-fade-in`}>
                    <div className="flex justify-between items-center border-b border-black/10 dark:border-white/10 pb-2.5">
                        <h3 className="font-black text-sm flex items-center gap-1.5">
                            <CardIcon className="w-4 h-4 text-purple-500" />
                            <span>Cartão</span>
                        </h3>
                        <span className="text-[10px] opacity-60">toque pra virar</span>
                    </div>
                    ...
                    {/* ENDEREÇO */}
                    <div className={`order-4 p-4 rounded-3xl ${cardClass} space-y-3 animate-fade-in`}>
                        <div className="flex justify-between items-center border-b border-black/10 dark:border-white/10 pb-2.5">
                            <h3 className="font-black text-sm flex items-center gap-1.5">
