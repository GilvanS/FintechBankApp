        ...
        <div className="w-full max-w-6xl mx-auto space-y-4 p-4">
            ...
            <div className="grid grid-cols-1 lg:grid-cols-[1.05fr_0.95fr] gap-4">
                <div className="space-y-4">
                    {/* PERFIL */}
                    <div className={`p-4 rounded-3xl ${cardClass} space-y-3 animate-fade-in`}>
                ...
                <div className={`p-4 rounded-3xl ${cardClass} space-y-3 animate-fade-in lg:sticky lg:top-4 self-start`}>
                    <div className="flex justify-between items-center border-b border-black/10 dark:border-white/10 pb-2.5">
                        <h3 className="font-black text-sm flex items-center gap-1.5">
