                        ...
                        <div className="bg-black/5 dark:bg-white/5 p-6 rounded-2xl border border-black/10 dark:border-white/10 space-y-6">
                            ...
                            <div className="grid grid-cols-1 sm:grid-cols-2 gap-3 pt-4 border-t border-black/10 dark:border-white/10">
                                <StatTile
                                    ...
                                    value={`Dia ${searchedUser.billingDay || 10}`}
                                ...
                                <StatTile
                                    icon={CreditCard}
                                    label="Fatura Aberta"
                                    value={`R$ ${(searchedUser.creditCard?.currentInvoice ?? 0).toFixed(2)}`}
                                ...
                                <StatTile
                                    ...
                                    value={`R$ ${(searchedUser.creditCard?.closedInvoice ?? 0).toFixed(2)}`}
                                ...
                                <StatTile
                                    ...
                                    value={`R$ ${(searchedUser.creditCard?.currentInvoiceTotal ?? 0).toFixed(2)}`}
                                ...
                                <StatTile
                                    ...
                                    value={`${(searchedUser.creditCard?.availableLimit ?? 0) < 0 ? '-' : ''}R$ ${Math.abs(searchedUser.creditCard?.availableLimit ?? 0).toFixed(2)}`}
