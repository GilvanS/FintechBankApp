/**
 * Grafico de pagamentos do cliente (7 dias) usando recharts.
 * Portado de WEB/components/PaymentTimelineChart.tsx.
 * Adaptado: getUserStatement via services/api do MOBILE e useAppState local.
 */
