...
import { 
  X, Send, CheckCircle2, AlertTriangle, Smartphone, Mail, Hash, 
  User as UserIcon, Key, Utensils, Car, Tv, Heart, MoreHorizontal, 
              ...
              {[
                ...
                return (
                  <button
                    ...
                    className={`flex flex-col items-center justify-center py-2 px-1 rounded-xl border relative transition-all active:scale-[0.93] cursor-pointer ${
                      isSelected
                        ? isMidnight
