...
const Admin: React.FC<{ isOpen: boolean; onClose: () => void; }> = ({ isOpen, onClose }) => {
    ...
    const applyBillingScenario = async (scenario: string) => {
        ...
        setBillingMsg({ text: res.success ? `Cenário "${scenario}" applied.` : res.message || 'Erro.', ok: !!res.success });
                                ...
                                >
                                    ...
                                    >
                                        ...
                                        <button
                                            ...
                                            data-testid={`btn-admin-deny-limit-${req.cpf}`}
                                            data-cy={`btn-admin-deny-limit-${req.cpf}`}
