    ...
    return (
        <div className="pt-6">
            <form onSubmit={handleSubmit} className="space-y-4">
                <div>
                    <label htmlFor="pix-key" className="text-sm font-medium text-gray-400">Para quem você quer transferir?</label>
                    <input
                        id="pix-key"
                        type="text"
                        value={pixKey}
                        ...
                        required
                        className="w-full px-4 py-3 mt-1 bg-gray-900 border-2 border-gray-700 rounded-lg text-white placeholder-gray-500 focus:outline-none focus:ring-2 focus:ring-green-500"
                    />
                </div>
                <div>
                    <label htmlFor="pix-amount" className="text-sm font-medium text-gray-400">Valor</label>
                     <input
                        id="pix-amount"
                        type="text"
                        inputMode="decimal"
                        ...
                        placeholder="R$ 0,00"
                        required
                        className="w-full px-4 py-3 mt-1 bg-gray-900 border-2 border-gray-700 rounded-lg text-white placeholder-gray-500 focus:outline-none focus:ring-2 focus:ring-green-500 text-2xl font-bold"
                    />
                </div>
                 <div>
                    <label htmlFor="pix-description" className="text-sm font-medium text-gray-400">Descrição (opcional)</label>
                    <input
                        id="pix-description"
                        type="text"
                        value={description}
                ...
                {resultMessage && (
                    <p className={`text-sm p-2 rounded-md ${resultMessage.type === 'success' ? 'text-green-400 bg-green-900/50' : 'text-red-400 bg-red-900/50'}`}>
                        {resultMessage.text}
                    </p>
                )}
