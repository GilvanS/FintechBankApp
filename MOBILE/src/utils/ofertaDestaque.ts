 ...
 * sozinho quando o tempo vira, e duas pessoas que abrem a loja no mesmo
 * momento veem o mesmo produto, sem precisar de estado compartilhado.
 *
 * Espelha WEB/utils/ofertaDestaque.ts — mesma lógica, mesma chave de
 * localStorage, para o admin e a loja concordarem sobre o destaque atual.
 */
...
export function salvarIntervaloOferta(intervalo: IntervaloOferta): void {
    ...
    // para que a loja aberta no mesmo documento reaja na hora.
