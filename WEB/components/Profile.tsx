...
import { Shield, HelpCircle, Info, Palette, Check, Edit2, Sun, Moon, Fingerprint, Bell, AlertTriangle, Sliders, Zap, Clock, CreditCard, Calendar, FileText, ShieldCheck } from 'lucide-react';
...
export default function Profile({ onNavigate, activeSection }: ProfileProps) {
  ...
  return (
    <div className="h-full flex flex-col bg-volt-yellow dark:bg-black w-full relative overflow-y-auto no-scrollbar">
      <div className="space-y-6 pb-28 pt-4 px-4 max-w-5xl w-full flex-grow">
        ...
        {activeSection === 'ajuda' && (
          <>
            ...
            <section className="space-y-2.5">
              <h4 className="text-xs font-black text-black dark:text-white uppercase tracking-wider pl-1">Central de Ajuda</h4>
        ...
        {/* Ação global — visível em todas as telas dedicadas */}
        {user?.role === 'admin' && (
